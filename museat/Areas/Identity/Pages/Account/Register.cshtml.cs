...
namespace museat.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            RoleManager<IdentityRole> roleManager) // Buraya eklendi
        {
            ...
            _roleManager = roleManager; // Buraya eklendi
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // ROL ATAMA İŞLEMİ BURADA YAPILIYOR
                    if (!string.IsNullOrEmpty(Input.Role))
                    {
                        // Rol veritabanında var mı kontrol et, yoksa oluştur
